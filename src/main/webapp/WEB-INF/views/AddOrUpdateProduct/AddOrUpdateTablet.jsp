...
<title>ADD|UPDATE Tablet</title>
</head>
<body>
<%!
String requestedJob="";
String mainFeatures[]={"name","brand","mainImageUrl","size","tabletWeight","bestBuyPrice","processor","RAM","releasedOS",};
...
<%}%>
	 ...
	 <spring:url value="/tablet/AddProduct" var="AddProductActionUrl" />   
