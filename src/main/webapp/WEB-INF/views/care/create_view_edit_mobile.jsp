...
<span class="profileHeader" >Create Mobile</span>
<%}else{ %>
<span class="profileHeader" >Edit <b>"<u><%=productId%></u>"</b></span>
<%} %>
</div>
<div class="enginContent" style="height:auto;">
<form:form modelAttribute="formAttribute" method="POST" action="/care/save/mobile">
<div class="enginContent" style="height:auto;">
		...
		<div class="enginContent" style="height:auto; width:1000px;margin-left:50px">
				...
				<tr>
					<td>phoneType</td>
					<td><form:select path="phoneType" items="${phoneTypeList}"/></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Price</td>
...
<table class="planbFont">		
				<tr>
					<td width=190>Top headline feature:</td>
					<td width=140>&nbsp;</td>
				</tr> 
				<%for(int i=0;i<5;i++){%>
				<tr>
