...
public class MobileUtilPojo {
	...
	public String toString() {
		return "MobileUtilPojo [topHeadlineFeatures=" + topHeadlineFeatures + ", name=" + name + ", brand=" + brand + ", mainImageUrl=" + mainImageUrl + ", phoneType="
				+ phoneType + ", restImageUrl=" + restImageUrl + ", bestBuyPrice=" + bestBuyPrice + ", colors=" + colors + ", processor=" + processor + ", releasedOS="
				+ releasedOS + ", accessories=" + accessories + ", additionalFeatures=" + additionalFeatures + ", ram=" + ram + ", overViewDescription=" + overViewDescription
				+ ", overViewReleaseDate=" + overViewReleaseDate + ", overViewMarketStaus=" + overViewMarketStaus + ", overViewPhoneWeight=" + overViewPhoneWeight
				+ ", overViewDimension=" + overViewDimension + ", overViewBodyMaterial=" + overViewBodyMaterial + ", overViewReleaseOS=" + overViewReleaseOS
				...
				+ ", displayDisplayTechnology=" + displayDisplayTechnology + ", displayDtherDisplayFeatures=" + displayDtherDisplayFeatures + ", batteryTalkTime="
				+ batteryTalkTime + ", batteryBatteryCapacity=" + batteryBatteryCapacity + ", batteryBatteryTechnology=" + batteryBatteryTechnology + ", InternalStorage="
				+ InternalStorage + ", ExpendableStorageFeatures=" + ExpendableStorageFeatures + ", connectivityAndFeaturesWireLessConnectivityFeatures="
				...
				+ ", connectivityAndFeaturesBluetoothVersion=" + connectivityAndFeaturesBluetoothVersion + ", connectivityAndFeaturesSimCardSize="
				+ connectivityAndFeaturesSimCardSize + ", connectivityAndFeaturesChargingOptions=" + connectivityAndFeaturesChargingOptions
				+ ", connectivityAndFeaturesSensors=" + connectivityAndFeaturesSensors + ", connectivityAndFeaturesothersConnectivityFeatures="
				+ connectivityAndFeaturesothersConnectivityFeatures + ", connectivityAndFeaturesNetworkFeatures=" + connectivityAndFeaturesNetworkFeatures + "]";
	}
	public MobileUtilPojo() {
		super();
